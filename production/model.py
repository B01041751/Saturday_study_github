...
mlflow.sklearn.log_model(
    sk_model=model,
    artifact_path="iris_decision_tree_model", # This name will be the folder name in your artifacts
    registered_model_name="IrisDecisionTreeClassifier" # This registers it in the Model registry
)
